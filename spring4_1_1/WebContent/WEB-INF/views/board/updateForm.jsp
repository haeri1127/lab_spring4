...
<body>
   ...
   <div style="margin-bottom:20px">
    ...
    <div style="margin-bottom:20px">
        <input class="easyui-textbox" name="bm_writer" value="<%=bm_writer%>" label="작성자:" labelPosition="top" data-options="prompt:'작성자'" style="width:250px;">
    </div>        
    <div style="margin-bottom:20px">
    ...
    <div style="margin-bottom:20px">
        <input class="easyui-filebox" name="bs_file" value="<%=bs_file%>" label="첨부파일:" labelPosition="top" data-options="width:'400px'" >
    </div>
   	</form>
    <div id="ft_ins">
		<a href="javascript:updAction()" class="easyui-linkbutton" data-options="iconCls:'icon-save',plain:true">수정완료</a>
